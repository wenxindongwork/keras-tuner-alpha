...
This test validates that the MaxText implementation of Gemma-2 models produces logits that are
...
if __name__ == "__main__":
    test("google/gemma-2-2b", logits_tol=0.5, top1_token_tol=0.01)
    test("google/gemma-2-9b", logits_tol=1.0, top1_token_tol=0.02)
