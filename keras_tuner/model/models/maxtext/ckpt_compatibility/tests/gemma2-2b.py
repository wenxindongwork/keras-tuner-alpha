...
# Load saved model 
model = AutoModelForCausalLM.from_pretrained("/dev/shm/temp/hf/checkpoint/", torch_dtype=torch.float32)

# Load reference model
golden_model = AutoModelForCausalLM.from_pretrained("google/gemma-2-2b", torch_dtype=torch.float32)
